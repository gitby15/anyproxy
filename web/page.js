...
function init(React){
	var MapForm = __webpack_require__(13).init(React),
		MapList = __webpack_require__(1).init(React);
...
module.exports.fetchConfig = __webpack_require__(1).fetchConfig;
...
function init(React){
	var RecordRow   = __webpack_require__(14).init(React);
...
var EventManager    = __webpack_require__(9),
	Anyproxy_wsUtil = __webpack_require__(8),
	React           = __webpack_require__(11);

var WsIndicator = __webpack_require__(7).init(React),
	RecordPanel = __webpack_require__(6).init(React),
	Popup       = __webpack_require__(5).init(React);

var PopupContent = {
	map    : __webpack_require__(0).init(React),
	detail : __webpack_require__(3).init(React),
	filter : __webpack_require__(4).init(React)
};
...
(function(){
	...
	(function (){
		...
		__webpack_require__(0).fetchConfig(function(initConfig){
